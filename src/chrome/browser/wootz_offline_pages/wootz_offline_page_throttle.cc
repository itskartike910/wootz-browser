...
WootzOfflinePageThrottle::CheckForOfflinePage() {
  ...
  //   if(!base::PathExists(fallback_page_path)){
  //     LOG(ERROR) << "Kartik: No fallback page found for LinkedIn search page";
  //     fallback_page_path = service->Get404PagePath();
  //     page_type = "404";
  //     LOG(INFO) << "Kartik: No fallback page found for LinkedIn search page, loading 404 page";
  //   }
  // } else {
